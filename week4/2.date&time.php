...
<body>
    ...
    <form method="POST" action="" class="container mt-5">
        <div class="row">
            ...
            <div class="col">
                <button type="submit" name="currDateUS" class="btn btn-primary">Get Current Date (Los Angles Time)</button> 
            </div>
            <div class="col">
                <button type="submit" name="currTimeLcl" class="btn btn-primary">Get Current Time (Local Time)</button> 
            </div>
            <div class="col">
                <button type="submit" name="currTimeUS" class="btn btn-primary">Get Current Time (Los Angles Time)</button> 
            </div>
        </div> 
    </form>
</body>

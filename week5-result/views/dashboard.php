    ...
    <div class="container mt-5 pt-4 text-center">
        ...
        <table class="table caption-top table-responsive mt-4 table-light">
            ...
            <tbody>
                ...
                <?php
                $num = 1;
                $queryData = $conn->query("SELECT p.id, 
                                            p.product_name, 
                                            p.release_year,
                                            p.price, 
                                            p.product_image, 
                ...
                ?>
                    <tr>
                        ...
                        <td><a href="./index.php?page=product&id=<?= $data['id'] ?>" class="btn btn-outline-warning px-3 py-1"><i class="bi bi-pencil me-2"></i>Edit</a></td>
                        <td><a href="./index.php?page=deleteProduct&id=<?= $data['id'] ?>" class="btn btn-outline-danger px-3 py-1"><i class="bi bi-trash2-fill me-2"></i>Delete</a></td>
                    </tr>
                <?php
                    $num++;
                }

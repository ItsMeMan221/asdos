                            ...
                            <div class="mb-md-5 mt-md-4 pb-5">
                                ...
                                <form method="POST" id="loginForm">
                                    <div class="form-outline form-dark mb-4">
                                        ...
                                        <small class="text-danger ml-5" id="userIdError"></small>
                                    ...
                                    <button type="submit" id="login" name="login" class="btn btn-outline-dark btn-lg px-5" value="Submit">LOG-IN</button>
                                </form>
                            </div>
                            <div>
